            ...
            if (!err) {
                ...
                db.get("SELECT COUNT(*) as count FROM products", (err, row) => {
                    if (row && row.count === 0) {
                        ...
                        stmt.run("Ultra-Slim Laptop Stand", "Improve your posture with this premium aluminum laptop stand.", 45.00, "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?q=80&w=800&auto=format&fit=crop");
